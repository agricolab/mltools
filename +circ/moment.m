function [mp  rho_p mu_p] = moment(alpha, w, p, cent, dim)

% [mp cbar sbar] = circ.moment(alpha, w, p, cent, dim)
...
%     left empty: circ.moment(alpha, [], [], [], dim)
%
%   Output:
...
if cent
  ...
  alpha = circ.dist(alpha,repmat(theta,v));
end
