function [phis, cdf, phiplot, cdfplot] = samplecdf(thetas, resolution)

% [phis, cdf, phiplot, cdfplot] = circ.samplecdf(thetas, resolution)
%
%   Helper function for circ.kuipertest.
