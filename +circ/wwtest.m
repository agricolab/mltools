function [pval table] = wwtest(varargin)
% [pval, table] = circ.wwtest(alpha, idx, [w])
% [pval, table] = circ.wwtest(alpha1, alpha2, [w1, w2])
...
function [alpha, idx, w] = processInput(varargin)
  ...
  elseif nargin==3
    ...
    error('Invalid use of circ.wwtest. Type help circ.wwtest.')
  end
end
