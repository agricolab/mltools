function loc_phys=mk_sensors_plane(sensors,pars,labels);
% MK_SENSORS_PLANE
%  ### docu incomplete ###

%  $Id: mk_sensors_plane.m 2205 2009-10-27 12:18:15Z schloegl $ 
...
if shift_cont>0  
   ...
   figure;
   for i=1:ns;
       text(s2d_n(i,1),s2d_n(i,2),labels(i));
   end
   axis([-.6 .6 -.6 .6]);  
...
%
%  $Id: locphys2locphys.m 2205 2009-10-27 12:18:15Z schloegl $ 
%  Copyright (C) 2003,2004 Guido Nolte
%  Adapted by Alois Schloegl 
%  This function is part of the BioSig project
%  http://biosig.sf.net/	
