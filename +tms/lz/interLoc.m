%{
    ...
    Description          : Serial communication interface for the Localite system
%}

classdef interLoc < handle
    ...
    methods(Access = public)
        ...
        function sendAmp(obj, amp1, amp2)
            ...
            data      = bin2dec([modell status waveForm modus]);
            message   = [command amp1 amp2 data];
        ...
        function currentDens(obj, curDens1, curDens2)
            ...
            data      = bin2dec([modell status waveForm modus]);
            message   = [command curDens1 curDens2 data];
        ...
        function sendMEP(obj, mepAmpMax, mepAmpMin, mepTime)
            startFlag = hex2dec('FE');
            length    = 13;
            command   = 4;
            
            %             message   = [command mepAmpMax mepAmpMin mepTime];
            %             message   = [command bin2dec('00000000') bin2dec('00000000') bin2dec('00000000') mepAmpMax ...
            %                          bin2dec('00000000') bin2dec('00000000') bin2dec('00000000') mepAmpMin ...
            %                          bin2dec('00000000') bin2dec('00000000') bin2dec('00000000') mepTime];
            
            %             message   = [command 0 0 0 round(mepAmpMax) ...
            %                          0 0 0 round(mepAmpMin) ...
            %                          0 0 0 round(mepTime)];
            lsb32 = @(x) fliplr(typecast(int32(x),'uint8'));
            message   = [command  lsb32(mepAmpMax) lsb32(mepAmpMin) ...
                lsb32(mepTime)];
...
%             end
    ...
    methods(Static)
        function ins = getInstance()
            ...
            if( ~strcmpi(class(instance), 'interLoc') )
                instance = interLoc();
            end
